...
export const SEED_USERS = [
  ...
  { id: 'demo-buch-1', anrede: 'Herr', vorname: 'Klaus',  nachname: 'Weber',      name: 'Klaus Weber',     email: 'buchhaltung@hwk-hannover.de', telefon: '',              rolle: 'buchhaltung',      objektIds: [],                   aktiv: true,  erstelltAm: T },
